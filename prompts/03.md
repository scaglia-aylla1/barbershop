No componente @app/\_components/service-item.tsx, ao clicar em "Reservar" abra o sheet que está em (url da interface do figma ou um print da tela ) usando o componente Sheet do shadcn.
